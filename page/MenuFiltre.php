<div class="text-center text-light">
        <form class="d-inline p-2 border border-dark rounded mb-3 p-3" method="GET" action="" style="background-color: rgba(33,37,41,0.7)">
            <select class="me-3 rounded primary" name='type' id='type'>
            ...
            <input class="me-3 rounded primary" type="number" name="prixMax" id="prixMax" min=<?= PRIX_MIN ?> max=<?= PRIX_MAX ?>>
            <label for="poidsMax">Poids Maximum (lbs): </label>
            <input class="me-3 rounded primary" type="number" name="poidsMax" id="poidsMax" min=<?= POIDS_MIN ?> max=<?= POIDS_MAX ?>>
